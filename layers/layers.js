...
var lyr__1 = new ol.layer.Vector({
                ...
                style: style__1,
                popuplayertitle: 'ที่ตั้งตลาดในเขตกทม.',
                interactive: true,
                title: '<img src="styles/legend/_1.png" /> ที่ตั้งตลาดในเขตกทม.'
            });
...
lyr__1.set('fieldLabels', {'id_market': 'inline label - visible with data', 'mar_name': 'inline label - visible with data', 'dcode': 'no label', 'address': 'inline label - visible with data', 'manage': 'no label', });
